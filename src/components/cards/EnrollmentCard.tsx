...
import type { TEnrollmentCourse } from "@types";
    ...
    <article className="group overflow-hidden rounded-3xl border border-surface-300 bg-surface-50 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      <div className="relative h-52 overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4 flex items-center gap-2 text-white">
          ...
          <div>
            <p className="text-xs text-white/70">Your course</p>
      ...
      <div className="p-5">
        ...
        <div className="mt-5 flex items-center justify-between">
          <div>
            <span className="text-xs text-ink-400">Course price</span>
          ...
          <button
            ...
            className="group/button cursor-pointer flex items-center gap-2 rounded-xl bg-primary-600 px-4 py-2.5 text-sm font-semibold text-white transition-all duration-300 hover:bg-primary-700"
          >
            <PlayCircle size={18} />
